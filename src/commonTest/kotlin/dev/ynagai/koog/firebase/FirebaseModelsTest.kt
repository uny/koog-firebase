...
class FirebaseModelsTest {
    ...
    fun modelsExposesAllNewGemini3xPresets() {
        ...
        assertContains(ids, "gemini-3.7-flash")
    ...
    @Test
    fun gemini3_7FlashOmitsDeprecatedTemperatureParameter() {
        assertFalse(FirebaseModels.Gemini3_7Flash.capabilities.orEmpty().contains(LLMCapability.Temperature))
        assertTrue(FirebaseModels.Gemini3_7Flash.capabilities.orEmpty().contains(LLMCapability.Speculation))
    }
